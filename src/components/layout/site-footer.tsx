        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-brand-ivory/70">
            ...
            {!contactChannels.length ? (
              <p>Os dados de contato serão preenchidos no painel.</p>
            ) : null}
          </div>
        </div>
      </div>

      <div className="flex flex-col gap-3 border-t border-brand-beige/10 px-4 py-4 text-center text-xs uppercase tracking-[0.24em] text-brand-ivory/42 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8 lg:text-left">
        <span>
